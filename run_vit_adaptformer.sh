...
CUDA_VISIBLE_DEVICES=0 python train_model_adapter.py --dataset cifar100 --task vtab --lr 0.013 --wd 1.0 --eval True --dpr 0.1 --tuning_mode adaptformer --model_type $model_type --model $model --model_checkpoint $model_checkpoint --topN $topN
