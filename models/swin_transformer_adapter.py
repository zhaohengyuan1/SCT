...
class Adapter(nn.Module):
    def __init__(self, ebed_dim, topN):
        super().__init__()
...
def _create_swin_transformer_adapter(variant, pretrained=False, **kwargs):  
    model = build_model_with_cfg(
        SwinTransformer_adapter, variant, pretrained,
...
@register_model
def swin_base_patch4_window7_224_in22k_adapter(pretrained=False, **kwargs):
    """ Swin-B @ 224x224, trained ImageNet-22k
    """
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
    return _create_swin_transformer_adapter('swin_base_patch4_window7_224_in22k', pretrained=pretrained, **model_kwargs)
