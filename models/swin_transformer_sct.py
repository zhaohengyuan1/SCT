...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, tuning_mode=None, channel_index=None, scale=0, scaleonx=None, topN=32):
        super().__init__()
        self.dim = dim
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 drop_path=0., norm_layer=nn.LayerNorm, downsample=None, use_checkpoint=False, tuning_mode=None, channel_index=None, scales=None, scaleonx=None, topN=96):
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(
                ...
                drop_path=drop_path[i] if isinstance(drop_path, list) else drop_path, norm_layer=norm_layer, tuning_mode=tuning_mode[i], channel_index=channel_index[i],
                scale=scales[depth], scaleonx=scaleonx, topN=topN)
...
class SwinTransformer_sct(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 use_checkpoint=False, weight_init='', tuning_mode=None, channel_index_dict=None, topN=32, scale=0, scaleonx=None, **kwargs):
        super().__init__()
        ...
        tuning_mode_list = [[None]*2, [None]*2, [None]*9+[tuning_mode]*9, [tuning_mode]*2]
        ...
        for i_layer in range(self.num_layers):
            layers += [BasicLayer(
                ...
                channel_index=channel_index_dict['index'][(sum(depths[:i_layer+1])-depths[i_layer]):sum(depths[:i_layer+1])],
                scale=scale, scaleonx=scaleonx,
                topN=topN
            ]
...
def _create_swin_transformer_sct(variant, pretrained=False, **kwargs):  
    model = build_model_with_cfg(
        SwinTransformer_sct, variant, pretrained,
...
@register_model
def swin_base_patch4_window7_224_in22k_sct(pretrained=False, **kwargs):
    """ Swin-B @ 224x224, trained ImageNet-22k
    """
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
    return _create_swin_transformer_sct('swin_base_patch4_window7_224_in22k', pretrained=pretrained, **model_kwargs)
