...
from models import vision_transformer_adapter, vision_transformer_adaptformer, swin_transformer_adapter, swin_transformer_adaptformer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='vit_base_patch16_224_in21k_adapter')
    ...
    exp_base_path = './output/%s/%s/%s'%(args.model_type, args.task, config['name'].replace('adapter', args.tuning_mode)+'_dim_%d'%(topN))
